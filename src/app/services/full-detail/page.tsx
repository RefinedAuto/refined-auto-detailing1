        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-white/10">
              <Image src="/images/gs-5621.jpg" alt="Essential full detailing" fill className="object-cover" priority />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-white/10 order-2 lg:order-1">
              <Image src="/images/gs-5758.jpg" alt="Elite full detailing" fill className="object-cover" />
            </div>
